...
JBMP_VERSION := v$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)_$(PRODUCT_BUILDTYPE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)
JBMP_NAMEVER := JBMP-v$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)_$(PRODUCT_BUILDTYPE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)
